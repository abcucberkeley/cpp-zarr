...
if isunix && ~ismac
    ...
    mex -outdir ../cpp-zarr_linux -output createZarrFile.mexa64 -v CXXOPTIMFLAGS="-O2 -DNDEBUG" LDOPTIMFLAGS="-Wl',-rpath='''$ORIGIN'''' -O2 -DNDEBUG" CXXFLAGS='$CXXFLAGS -O2 -fopenmp' LDFLAGS='$LDFLAGS -O2 -fopenmp' -I'/clusterfs/fiona/matthewmueller/cppZarrTest' -luuid createzarrfilemex.cpp ../src/helperfunctions.cpp ../src/zarr.cpp
    ...
    system(['patchelf --replace-needed libstdc++.so.6 libstdc++.so.6.0.30 ' releaseFolder '/createZarrFile.mexa64']);
